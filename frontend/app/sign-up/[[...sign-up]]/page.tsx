          ...
          <div>
            <div className={`mb-6 ${preview ? "text-left" : "text-center"}`}>
              <h1 className="text-2xl font-bold text-gray-900 mb-2">
                {preview ? "Sign up to get your report" : "Sign In to Save Your Reports"}
              </h1>
              <p className="text-gray-600 text-sm">
                {preview
                  ? "Create an account to generate your full zoning feasibility report."
                  : "Create an account or sign in to generate and access your zoning reports."}
              </p>
            </div>
            ...
            <div className="lg:sticky lg:top-24 space-y-5">
              ...
              >
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Sign up to generate your full zoning feasibility analysis
                </p>
              </div>
            </div>
          )}
